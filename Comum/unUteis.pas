...
type
  ...
  public
    ...
    class procedure LerDadosConexao(ACaminhoInstalacao: string; var AServidor,
      AHost, ADataBase, ALogin, ASenha: string);
    ...
    class procedure GravarDadosConexao(ACaminhoInstalacao, AServidor, AHost,
      ADataBase, ALogin, ASenha: string);
  end;
...
class procedure TutilitarioServidor.GravarDadosConexao(
  ACaminhoInstalacao, AServidor, AHost, ADataBase, ALogin, ASenha: string);
var
  ArquivoIni : TIniFile;  
begin
  ...
  try
    ...
    ArquivoIni.WriteString('Conexao', 'DataBase', ADataBase);
...
class procedure TutilitarioServidor.LerDadosConexao(ACaminhoInstalacao: string;
  var AServidor, AHost, ADataBase, ALogin, ASenha: string);
var
  ArquivoIni : TIniFile;
begin
  Delete(ACaminhoInstalacao, Length(ACaminhoInstalacao) - 7, 8); // Pelo Cliente
  ...
  try
    ...
    ADataBase := ArquivoIni.ReadString('Conexao', 'DataBase', ADataBase);
    ALogin := ArquivoIni.ReadString('Conexao', 'User_Name', ALogin);
    ASenha := ArquivoIni.ReadString('Conexao', 'Password', ASenha);
  finally
    ArquivoIni.Free;
  end;
end;
